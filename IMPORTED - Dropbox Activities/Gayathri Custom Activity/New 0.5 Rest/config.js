define([], function(){              //Needed for AMD and JSONP support
    return {                      //Returns a well-formed JSON object 
        ...
        "key": "RestActivityNewV0.5", //AppExtensionId
        ...
        "save": {
            "uri": "https://posttestserver.com/post.php?dir=et_test_gmjsave",
            "verb": "POST",
            "body": "{\"Email\": \"%%emailAddr%%\", \"First Name\": \"%%FirstName%%\", \"Last Name\": \"%%LastName%%\"}",
            "header": "",
	    "format": "json",
        ...
        "publish": {
            "uri": "https://posttestserver.com/post.php?dir=et_test_gmjPub&status_code=200",
            "verb": "POST",
            "body": "{\"Email\": \"%%emailAddr%%\", \"First Name\": \"%%FirstName%%\", \"Last Name\": \"%%LastName%%\"}",
            "header": "",
	    "format": "json",
        ...
        "validate": {
            "uri": "https://posttestserver.com/post.php?dir=et_test_gmjval&status_code=200",
            "verb": "POST",
            "body": "{\"Email\": \"%%emailAddr%%\", \"First Name\": \"%%FirstName%%\", \"Last Name\": \"%%LastName%%\"}",
            "header": "",
	    "format": "json",
