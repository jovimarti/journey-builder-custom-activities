define([], function(){              //Needed for AMD and JSONP support
    return {                      //Returns a well-formed JSON object 
        ...
        "key": "ED22540D-03C4-48D1-B736-108FA3D5ED39", //AppExtensionId
        "partnerApiObjectTypeId": "IXN.CustomActivity.REST",
        "lang": {
            "en-US": {        //Culture name followed by object
                "name": "Thiru Custom Activity OLD V0.5",    // "name" is a reserved word representing the name that appears in the custom activity modal
        ...
        "save": {
            "uri": "https://posttestserver.com/post.php?sleep=30&dir=et_test_jsave",
            "verb": "POST",
            "body": "{\"Email\": \"%%emailAddr%%\", \"First Name\": \"%%FirstName%%\", \"Last Name\": \"%%LastName%%\"}",
            "header": "",
            "format": "json",
        ...
        "publish": {
            "uri": "https://posttestserver.com/post.php?sleep=30&dir=et_test_jPub&status_code=200",
            "verb": "POST",
            "body": "{\"Email\": \"%%emailAddr%%\", \"First Name\": \"%%FirstName%%\", \"Last Name\": \"%%LastName%%\"}",
            "header": "",
            "format": "json",
        ...
        "validate": {
            "uri": "https://posttestserver.com/post.php?sleep=30&dir=et_test_jval&status_code=200",
            "verb": "POST",
            "body": "{\"Email\": \"%%emailAddr%%\", \"First Name\": \"%%FirstName%%\", \"Last Name\": \"%%LastName%%\"}",
            "header": "",
            "format": "json",
