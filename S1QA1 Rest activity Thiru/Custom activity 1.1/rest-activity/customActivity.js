define([
    ...
    function initialize (data) {
        ...
        var saveBody = payload['configurationArguments'].save && payload['configurationArguments'].save.body;

        try {
            saveBody = JSON.parse(saveBody);
        } catch(e) {

        }

        subject = saveBody && saveBody.subject || '';
    ...
    function save() {
        ...
        // Example of adding key-value pairs to the save body
        if (subject) {
            var saveBody = payload['configurationArguments'].save.body;
            saveBody = JSON.parse(saveBody);
            saveBody.subject = subject;
            saveBody = JSON.stringify(saveBody);
            payload['configurationArguments'].save.body = saveBody;
        }
		...
		payload['configurationArguments'].partnerActivityId = '12345678';
